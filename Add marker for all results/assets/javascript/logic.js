    ...
    $.ajax({ // call
        ...
        method: "GET",
            ...
            for (let i=0; i < businesses.length; i++){
              ...
              // find address of current business to place marker
              // let addressArray = businesses[i].location.display_address
              // let address = ''
              // addressArray.forEach(function(elem) {
              //   address += ' ' + elem
              // })
              ...
              console.log('lng: ' + lngSearch)
              map.center.lat = latSearch
              map.center.lng = lngSearch
